  ...
  render() 
  {
    return (
      <View style={{flex:1, flexDirection:'column', width: '100%', height:'100%', backgroundColor: 'white', padding: '5%'}}>
            <View style={{flex: 1}}> 
                <Text style={{fontWeight:'bold'}}>Indstil support</Text>
                <Image source={require("../images/video3.png")} resizeMode='cover' style={{height: '80%', width:'100%'}}></Image>

            </View>
            <View style={{flex: 1}}> 
                <Text style={{fontWeight:'bold'}}>Indstil indstilling</Text>
                <Image source={require("../images/video2.png")} resizeMode='cover' style={{height: '80%', width:'100%'}} ></Image>
            </View>
            <View style={{flex: 1}}> 
                 <Text style={{fontWeight:'bold'}}>Indstil vinkel</Text>
